	      ...
	      <tr>
		      <td class="bg_white">
		        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
		          <tr>
		            <td class="email-section" style="padding-top:5px;">
		            	<div class="heading-section heading-section-dark">
                    <p style="text-align: right;padding-bottom:10px;"><a href="https://sale.harjassinfotech.org/" class="">Login</a></p>
                    <p style="padding-bottom:20px;">Sie haben eine neue Reservierung erhalten.<br> Sehen Sie hier die Details:</p>
		            	</div>
                        ...
                        <tr>
                          <th>Telefon</th>
                          <td><a href="tel" class="text-dark">{{$phone_no}}</a></td>
                        </tr>
                        <tr>
                          <th>Email</th>
                          <td><a href="mailto:info@foodbee.de" class="text-dark">{{$email}}</a></td>
                        </tr>
                        <tr>
                          <th>Res #</th>
                        ...
                        <tr>
                            <td colspan="2" class="email-section" style="text-align:center; padding-top:30px; padding-bottom:30px;">
                                <p><a href="https://sale.harjassinfotech.org/" class="btn btn-primary" style="font-size:16px;">Verwalten</a></p> 
                            </td>
                          </tr>
                        </table>
		            </td>
