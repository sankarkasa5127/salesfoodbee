...
<head>
    ...
    <title>logo</title>
     @if(isset($_POST['downloads']))
      <link href="Theme-silver/css/bootstrap.min.css" rel="stylesheet">
       @else
        <link href="{{asset('public/Theme-silver/css/bootstrap.min.css')}}" rel="stylesheet">
    @endif

    @if(isset($_POST['downloads']))
      <link href="Theme-silver/css/style.css" rel="stylesheet">
       @else
       <link href="{{asset('public/Theme-silver/css/style.css')}}" rel="stylesheet">
    @endif
...
<body>
    ...
    @if(isset($_POST['downloads']))
      <section id="home" class="banner" style="background: url(image/{{$website->bannerimg}}) no-repeat;">
       @else
         <section class="banner" style="background: url({{ asset('public/uploads/website/themes'.$user->userId.'/' . $website->bannerimg) }}) no-repeat;">
    @endif
   
        <div class="box_higet">
            <header id="myHeader" class="header d-flex flex-wrap justify-content-between py-3">
                    <div class="row">
                        <a href="/" class="logo_bg text-center align-items-center col-lg-12 col-md-2 mb-2 mb-md-0 text-dark text-decoration-none">
                             @if(isset($_POST['downloads']))
						...
						<ul class="nav col-12 col-lg-10 col-md-10 col-md-auto mb-2 mb-md-0 m-hide">
                            ...
                            <li><a href="#menu" class="nav-link px-2 link-dark">Menu</a></li>
                            <li><a href="#gallery" class="nav-link px-2 link-dark">Gallery</a></li>
                            <li><a href="#booktable" class="nav-link px-2 link-dark">Book Table</a></li>
                        ...
                        <div class="textand">
                            <div class="leftsed">
                                 @if(isset($_POST['downloads']))
                             <img src="Theme-silver/images/phoneicn.png" />
                               @else
                                  <img src="{{asset('public/Theme-silver/images/phoneicn.png')}}" />
                            @endif
                               
                            </div>
                          <span>Reservation</span>
                            <h2>+{{$theme->Phone_no}}</h2>
                        </div>
                </div>
            </header>
        </div>
        <div class="container">
            <div class="banner_text">
                ...
                <a class="buttonclick bgred" href="#booktable">Book A Table</a>
            </div>
        </div>
    </section>
            ...
            <div class="box_abouts">
                <div class="row">
                    <div class="col-md-12 col-xl-6 col-xxl-6 col-lg-6 padingleftss">
                        ...
                        <p>{{$theme->aboutUsContent}}
                        </p>
                        <button type="button" class="btn btndefultt bgred aboutbtn">Show more</button>
                         @if(isset($_POST['downloads']))
                             <a href="{{$theme->videoLink}}" class="watchvideo"><img src="Theme-silver/images/watch.png" /> Watch Video</a>
                               @else
                            <a href="#" class="watchvideo"><img src="{{asset('public/Theme-silver/images/watch.png')}}" /> Watch Video</a>
                            @endif
                 ...
                 @if(isset($_POST['downloads']))
                              <img class="boxppd" src="Theme-silver/images/bear.png')}}" />
                               @else
                             <img class="boxppd" src="{{asset('public/Theme-silver/images/bear.png')}}" />
                            @endif
    ...
    <section class="menu">
        <img class="menu_right" src="public/Theme-silver/images/menuback.png" />
        <div class="container">
            <div class="box_menu">
                <div class="box_menu_inner">
                    ...
                    <li class="nav-item" role="presentation" >
                      <a class="nav-link {{ $key == 0 ? 'active' : '' }}"  data-bs-toggle="tab" style="padding: 15px 71px !important;" href="#tab{{ $key }}" role="tab">{{ $menu->category }}</a>
                    </li>
                    @endforeach
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="boxmenubg">
                                        ...
                                        <button type="button" class="btn btndefultt bgred aboutbtn newaddbgbg">View All Menu</button>
                                        <h3>Available:</h3>
                                        <p>Sun-Sat/10.00AM - 8.00PM</p>
                                        <img src="public/Theme-silver/images/bgnewe.png" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <ul class="box_menus">
                                    ...
                                    @foreach($tabmenuitem  as $item)
                                        ...
                                        <li>
                                            <span class="price_box">
                                                <h2>{{$item->name}}</h2>
                                                <!--p>
                                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod Lorem ipsum dol
                                                </p-->
                                            </span>
                                            <span class="pricebox"><i></i>{{$item->price}}&euro;</span>
                                        </li>
    ...
    <section class="about_us whywebest welcomebar">
        <div class="container">
            <div class="box_abouts">
                <div class="row">
                    <div class="col-md-12 col-xl-6 col-xxl-6 col-lg-6">
                     ...
                     @foreach($Testimonials as $Test)
                      @if(isset($_POST['downloads']))
                         <img class="img-fluid mrigt" src="image/{{$Test}}" />
                           @else
                         <img class="img-fluid mrigt" src="{{ asset('public/uploads/website/themes'.$user->userId.'/' . $Test) }}" />
                        @endif
                        
                        @endforeach
                    </div>
                    <div class="col-md-12 col-xl-6 col-xxl-6 col-lg-6 padingleftss">
                        <span>Welcome To Logo Restaurant<br />& Wine Bar</span>
                        <p>
        ...
        <div class="container">
            <div class="box_abouts">
                <div class="row">
                    ...
                    <div class="col-md-12 col-xl-6 col-xxl-6 col-lg-6 padingleftss">
                        ...
                        <div class="row wdtfull">
                            <div class="col-md-6 col-xl-5 col-xxl-5 col-sm-6">
                                <span class="stepss">
                                     @if(isset($_POST['downloads']))
                                         <img src="Theme-silver/images/ticdde.png" /><p>{{$theme->service1}}</p>
                                           @else
                                        <img src="{{asset('public/Theme-silver/images/ticdde.png')}}" /><p>{{$theme->service1}}</p>
                                        @endif
                            ...
                            <div class="col-md-6 col-xl-5 col-xxl-5 col-sm-6">
                                <span class="stepss">
                                    @if(isset($_POST['downloads']))
                                          <img src="Theme-silver/images/ticdde.png" /><p>{{$theme->service2}}</p>
                                           @else
                                         <img src="{{asset('public/Theme-silver/images/ticdde.png')}}" /><p>{{$theme->service2}}</p>
                                        @endif
                                   
                                </span>
                            </div>
                        </div>
                        <div class="row wdtfull mtbfd">
                            <div class="col-md-6 col-xl-5 col-xxl-5 col-sm-6">
                                <span class="stepss">
                                     @if(isset($_POST['downloads']))
                                           <img src="Theme-silver/images/ticdde.png" /><p>{{$theme->service3}}</p>
                                           @else
                                          <img src="{{asset('public/Theme-silver/images/ticdde.png')}}" /><p>{{$theme->service3}}</p>
                                        @endif
                            ...
                            <div class="col-md-6 col-xl-5 col-xxl-5 col-sm-6">
                                <span class="stepss">
                                     @if(isset($_POST['downloads']))
                                            <img src="Theme-silver/images/ticdde.png" /><p>{{$theme->service4}}</p>
                                </span>
                                           @else
                                          <img src="{{asset('public/Theme-silver/images/ticdde.png')}}" /><p>{{$theme->service4}}</p>
                                </span>
                                        @endif
                        ...
                        <button type="button" class="btn btndefultt bgred aboutbtn newaddbgbg">Show More</button>
                    </div>
                    <div class="col-md-12 col-xl-6 col-xxl-6 col-lg-6">
                        <?php $whyweare = explode("|",$website->whyweareimage);?>
                        @foreach($whyweare as $whywe)
                        @if(isset($_POST['downloads']))
                             <img class="img-fluid bgleftdds" src="image/{{$whywe}}" />
                           @else
                          <img class="img-fluid bgleftdds" src="{{ asset('public/uploads/website/themes'.$user->userId.'/' . $whywe) }}" />
                        @endif
                 ...
                 @if(isset($_POST['downloads']))
                      <img class="postflld" src="Theme-silver/images/panbg.png" />
                   @else
                  <img class="postflld" src="{{asset('public/Theme-silver/images/panbg.png')}}" />
                @endif
            ...
            <div class="row">
                <?php $gallery = explode("|",$website->galleryimage);?>
                    ...
                    <div class="img1 col-xxl-4 col-md-4">
                        ...
                        @else
                        <img class="g1" src="{{ asset('public/uploads/website/themes'.$user->userId.'/' . $gall) }}" />
                        @endif
                    </div>
                @endforeach
            </div>
    ...
    <?php $BookTable = explode("|",$website->BookTableimage);?>
        ...
        @if(isset($_POST['downloads']))
                      <section class="booktable" id="booktable" style="background: url(image/{{$Book}});" >
                   @else
                  <section id="booktable" class="booktable" style="background: url({{ asset('public/uploads/website/themes'.$user->userId.'/' . $Book) }});" >
                @endif
                     ...
                     <div class="carousel-inner">
                       ...
                       <?php $review = explode("|",$theme->Review);?>
                         ...
                         <div class="carousel-item active">
                             <div class="rightboxc">
                                @if(isset($_POST['downloads']))
                                  <img class="mb-2" src="Theme-silver/images/star.png">
                               @else
                               <img class="mb-2" src="{{asset('public/Theme-silver/images/star.png')}}">
                            @endif
                                 ...
                                 <div class="leftbbgd">
                                    @if(isset($_POST['downloads']))
                                   <img height="83px" width="79px" src="/Theme-silver/images/icon-thumbnail.png" style="border-radius: 25%;" />
                               @else
                     ...
                     <p class="subtitle_menu">
                      ...
                      <form>
                            <input class="form-control" id="code_id" type="hidden" name="code" value="<?= $user->code; ?>" data-sb-validations="required" />
                             ...
                             <input class="form-control" id="user_id" type="hidden" name="userid" value="<?= $user->userId; ?>" data-sb-validations="required" />

                                <input class="form-control" id="rest_name" type="hidden" name="rest_name" value="<?= $user->name; ?>" data-sb-validations="required" />

                                <input class="form-control" id="rest_email" type="hidden" name="rest_email" value="<?= $user->email; ?>" data-sb-validations="required" />
                            <div class="mb-3 row">
                                <div class="col-md-6">
    ...
    <footer id="contact">
       ...
       @else
                ...
                <div class="row">
                    ...
                    <div class="col-xxl-2 col-md-2  col-lg-2 footersec">
                        ...
                        <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
                            ...
                            <li><a href="#contact" class="nav-link px-2 link-dark">Contact</a></li>
                            <li><a href="#about" class="nav-link px-2 link-secondary">About Us </a></li>
                            <li><a href="#menu" class="nav-link px-2 link-dark">Our Menu</a></li>
                            <li><a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal" class="nav-link px-2 link-dark">Impressum</a></li>
                    ...
                    <div class="col-xxl-3 col-md-12 col-lg-3 footersec">
                        <div style="width: 100%"><iframe width="100%" height="250" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="{{$theme->maplink}}"><a href="https://www.maps.ie/distance-area-calculator.html">measure acres/hectares on map</a></iframe></div>
                    </div>
                </div>
        ...
        @if(isset($_POST['downloads']))
                                    <script src="Theme-silver/js/bootstrap.bundle.min.js"></script>
                               @else
                                 <script src="{{asset('public/Theme-silver/js/bootstrap.bundle.min.js')}}"></script>
                            @endif
    </footer>
     <!-- Modal -->
