            ...
            <div id="content" class="mb-5">
                ...
                <div class="container-fluid  px-3 px-sm-5 my-2 my-sm-2">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4 mb-sm-0 pb-2">
                        <!-- <h1 class="col-md-4 h4 mb-0 text-gray-800 mob-back"><a href="{{route('index')}}"><i class="fa fa-arrow-left"></i> <span>Order History</span></a></h1> -->
                        <!-- Topbar Search -->
                        <form
                            class="form-inline mx-auto my-2 my-md-0 mw-100 navbar-search border mob-form">
                            ...
                            <a class="btn btn-info" href="{{route('AllOrders')}}">Vergangene Bestellung</a>
                        </div>
                    ...
                    <div class="row mt-0 mt-sm-2">
                        <div class="col-lg-12 px-0 px-md-3" id="tile-1">
                            <ul class="nav nav-tabs mb-3" id="pills-tab" role="tablist">
                                <div class="slider"></div>
                                <li class="nav-item">
                                    <a class="nav-link active" id="pills-process-tab" data-toggle="pill" href="#pills-process" role="tab" aria-controls="pills-process" aria-selected="false">New (<span id="newCount">{{$countInprocess}}</span>)</a>
                                </li>

                                  <li class="nav-item">
                                    <a class="nav-link" id="pills-accepted-tab" data-toggle="pill" href="#pills-accepted" role="tab" aria-controls="pills-accepted" aria-selected="false">Accepted ({{$countAccecpted}})</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" id="pills-ready-tab" data-toggle="pill" href="#pills-ready" role="tab" aria-controls="pills-ready" aria-selected="false">Ready({{$countready}})</a>
                                </li>
                                <li class="nav-item">
                                  <a class="nav-link" id="pills-delivered-tab" data-toggle="pill" href="#pills-delivered" role="tab" aria-controls="pills-delivered" aria-selected="true">Delivered({{$countdelivered}})</a>
                                </li>
                                <li class="nav-item">
                                  <a class="nav-link" id="pills-rejected-tab" data-toggle="pill" href="#pills-rejected" role="tab" aria-controls="pills-rejected" aria-selected="false">Rejected({{$countcancelled}})</a>
                                </li>
                              ...
                              <div class="tab-content " id="pills-tabContent">
                                <div class="tab-pane fade show active" id="pills-process" role="tabpanel" aria-labelledby="pills-process-tab">
                                    <div class="row" id="newOrder">
                                        ...
                                        <!--Box End---->
                                        @else
                                        <div class="col-md-6 mx-auto no-order-found text-center pt-5 mt-5">
                                            <img class="img-fluid mb-2" src="public/img/whisk.png">
                                            <h4 class="text-black font-weight-bold">No Orders!</h4>
...
<!-- View Detail Modal 
    ...
    <!-- View Detail Modal -->
      <!-- View Detail Modal -->
    <div class="modal fade" id="detailModal" tabindex="-1" role="dialog" aria-labelledby="detailModalLabel" aria-hidden="true" data-keyboard="false" data-backdrop="static">
