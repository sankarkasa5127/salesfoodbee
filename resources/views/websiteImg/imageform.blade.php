...
<div class="container-fluid">
	<form action="{{route('web_img_save')}}" method="post" enctype="multipart/form-data">
		@csrf
		<div class="mb-3">
		  <label for="exampleFormControlInput1" class="form-label">Image title</label>
		  </div>
		    <div class="col">
        <input type="text" class="form-control" name="imageTitle" placeholder="Title" aria-label="Title" required>
        @if($errors->has('imageTitle'))
			    <span style="color:red;">{{ $errors->first('imageTitle') }}</span>
			@endif
      </div>
		...
		<div class="mb-3 mt-5">
		  ...
		  @if($errors->has('logoimg'))
			    <span style="color:red;">{{ $errors->first('logoimg') }}</span>
			@endif
		    <div class="row">
		      <div class="col">
				  <div class="row">
		  ...
		  @if($errors->has('bannerimg'))
			    <span style="color:red;">{{ $errors->first('bannerimg') }}</span>
			@endif
		    <div class="row">
		      <div class="col">
				  <div class="row">
		  ...
		  @if($errors->has('aboutusimage'))
			    <span style="color:red;">{{ $errors->first('aboutusimage') }}</span>
			@endif
		    <div class="row">
		      <div class="col">
				  <div class="row">
		  ...
		  @if($errors->has('whyweareimage'))
			    <span style="color:red;">{{ $errors->first('whyweareimage') }}</span>
			@endif
		    <div class="row">
		      <div class="col">
				  <div class="row">
		  ...
		  <span>[648 x 690.11]</span>
		   @if($errors->has('BookTableimage'))
			    <span style="color:red;">{{ $errors->first('BookTableimage') }}</span>
			@endif
		    <div class="row">
		      <div class="col">
				  <div class="row">
		  ...
		  @if($errors->has('Testimonialsimage'))
			    <span style="color:red;">{{ $errors->first('Testimonialsimage') }}</span>
			@endif
		    <div class="row">
		      <div class="col">
				  <div class="row">
		  ...
		  @if($errors->has('galleryimage'))
			    <span style="color:red;">{{ $errors->first('galleryimage') }}</span>
			@endif
		    <div class="row">
		      <div class="col">
				  <div class="row">
